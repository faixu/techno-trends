      ...
      <main className="pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 space-y-6">
            <div className="inline-flex items-center space-x-2 bg-green-50 text-green-600 px-4 py-1.5 rounded-full text-sm font-bold uppercase tracking-wider">
              <Table className="w-4 h-4" />
              <span>50+ Excel Tips & Tricks</span>
            </div>
            <h1 className="text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight">
              Excel <span className="text-green-600">Mastery</span> Hub
            </h1>
            ...
            <div className="max-w-xl mx-auto relative mt-8">
              ...
              <input 
                ...
                className="w-full bg-gray-50 border border-gray-100 rounded-2xl py-4 pl-12 pr-6 focus:outline-none focus:ring-2 focus:ring-green-600 transition-all"
              />
            </div>
          </div>
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-gray-50">
                    ...
                    <Link to={`/article/${post.slug}`} className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center group-hover:bg-green-600 group-hover:text-white transition-all">
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-20">
              <p className="text-gray-500 text-lg">No Excel tips found matching your search.</p>
            </div>
          )}
        </div>
      </main>
